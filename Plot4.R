...
plot(cday, fdata$Sub_metering_1, type = "n",                        #Plot Line Graph 2
     xlab = "",
     ylab = "Energy sub metering")

points(cday, fdata$Sub_metering_1, col = "black", type = "l")
points(cday, fdata$Sub_metering_2, col = "orange",type = "l")
points(cday, fdata$Sub_metering_3, col = "blue", type = "l")
